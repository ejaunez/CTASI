<div class="posts index">
	...
	<tr>
		...
		<td><?php echo h($post['Post']['address']); ?>&nbsp;</td>
		<td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $post['Post']['post_id']), array('confirm' => __('Are you sure you want to delete # %s?', $post['Post']['post_id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
